...
grep -nE "→ ждёт|ждёт|dep:|блокер|blocked:|остановлен|ждёт согласования" \
  /home/natty/.claude/projects/*/memory/MEMORY.md 2>/dev/null
```
...
> **Условный шаг:** скрипт опционален. Если `/home/natty/IWE/DS-strategy/scripts/check-index-health.py` отсутствует — пропустить.

```bash
SCRIPT="/home/natty/IWE/DS-strategy/scripts/check-index-health.py"
