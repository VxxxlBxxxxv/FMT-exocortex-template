...
> **Инструкции:** `/home/natty/IWE/CLAUDE.md` | **Настройте под свою экосистему**
...
4. **Отчёты:** ВСЕ репо в /home/natty/IWE/
4. **Процессы:** Нельзя реализовывать без PROCESSES.md (CLAUDE.md § 3)
...
|---|-----|--------|--------|---------|
| WP-3 | **Перевести 1 абзац через API** | 3h | done | Сб 4 апр |
