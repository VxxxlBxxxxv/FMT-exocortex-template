...
<<<<<<< /tmp/tmp.cdrOjiQ3vm/claude-merge.md
...
>>>>>>> /tmp/tmp.cdrOjiQ3vm/files/CLAUDE.md
...
<<<<<<< /tmp/tmp.HYtE2fR8Mw/claude-merge.md
*Последнее обновление: 2026-04-30*
=======
*Последнее обновление: 2026-05-16*
>>>>>>> /tmp/tmp.HYtE2fR8Mw/files/CLAUDE.md
=======
...
**Триггеры:** «объясни», «на пальцах», «что сделали», «расскажи понятно», «простыми словами» — любая просьба объяснить итоги или суть работы.

**Правила ответа в этом режиме:**
- Только русский язык. Ноль английских слов, включая технические термины.
- Никаких имён файлов, путей, названий функций, имён воркеров, имён таблиц.
- Никаких commit-хешей, номеров строк, флагов команд.
