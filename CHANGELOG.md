...
## [Unreleased] — обновлено 2026-09-16

### Changed

- `2baf4de` chore(update): применённая поставка 0.40.0 (105 файлов)

### Fixed

- Открытие дня читает датированный SchedulerReport, отличает пустой каталог необязательной роли feedback-triage от развёрнутого исполнителя и не принимает старый недатированный журнал за сегодняшний успешный запуск.
- Защитный фильтр секретов принимает нормализованные имена MCP-инструментов шлюза вида `mcp__server_tool`, сохраняя блокировку секретов и массовых выгрузок.
