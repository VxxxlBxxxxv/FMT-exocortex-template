...
|-------|------|---------|------|
| Методология интеллектуальной работы, делегирование, коммуникация, организация работы, метод, артефакт, учёт, планирование | PACK-iwe-methodology | IWE | /home/natty/IWE/PACK-iwe-methodology/pack/iwe-methodology/ |
...
| Правило (глобальное) | `rule` | `/home/natty/IWE/CLAUDE.md` | Строки |
...
|---------|--------|-------------|
| _Мой бот_ | _your-org/my-bot_ | _/home/natty/IWE/your-org/my-bot/docs/_ |
