...
> Этот промпт выполняется headless (launchd/systemd, 3 раза в день: 09:00, 15:00, 21:00 UTC) или вручную.
...
- launchd/systemd: 3 раза в день — 09:00, 15:00, 21:00 UTC (автоматически)
